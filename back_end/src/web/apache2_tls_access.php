...
$sql ="select * from apache2_tls_access_log order by time desc;"; 
 
$result = mysql_query($sql,$conn);
?>

<p style="color:red;font-size:16px;">
Apache2 Https Access Log
</p>
...
{ ?>
	...
	<td>
 		<?php echo $row['protocol']; ?>
	</td>
	<td>
 		<?php echo $row['res_state']; ?>
	</td>
	<td>
 		<?php echo $row['send_bytes']; ?>
	</td>
	</tr>
<?php 
} ?>
