...
$sql ="select * from xferlog_log order by time desc;"; 
...
{ ?>
	...
	<td>
 		<?php echo $row['auth_method']; ?>
	</td>
	<td>
 		<?php echo $row['trans_state']; ?>
	</td>
	<td>
 		<?php echo $row['auth_id']; ?>
	</td>
	<td>
 		<?php echo $row['access_mode']; ?>
	</td>
	<td>
 		<?php echo $row['trans_direction']; ?>
	</td>
	<td>
